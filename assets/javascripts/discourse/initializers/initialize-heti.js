...
!(function (e, t) {
  ...
  var t = (function (e, t) {
    ...
    (n = e),
      (i = function () {
        ...
        function o(e, i) {
          i.offset || (i.offset = 0);
          var r = i.preset && n.PRESETS[i.preset];
          if (((i.portionMode = i.portionMode || "retain"), r))
            for (var o in r) t.call(r, o) && !t.call(i, o) && (i[o] = r[o]);
          (this.node = e),
            (this.options = i),
        ...
        return (
          ...
          (o.prototype = {
                ...
                (function r(a) {
                  for (var d = 0, c = a.length; d < c; ++d) {
                    ...
                    if ("string" == typeof p) {
                      if (i.global)
                        for (; (e = i.exec(p)); )
                          o.push(s.prepMatch(e, t++, n));
                      else (e = p.match(i)) && o.push(s.prepMatch(e, 0, n));
                      n += p.length;
                    } else r(p);
                  }
                })(r),
              ...
              e: for (;;) {
                if (
                  (a.nodeType === Node.TEXT_NODE &&
                    (!t && a.length + c >= d.endIndex
                      ? (t = {
                          node: a,
                          index: p++,
                          text: a.data.substring(
                            d.startIndex - c + this.options.offset,
                            d.endIndex - c
                          ),
                          indexInMatch: 0 === c ? 0 : c - d.startIndex,
                  ...
                  if (
                    ((a = this.replaceMatch(d, e, s, t)),
                    (c -= t.node.data.length - t.endIndexInNode),
                    (e = null),
                    (t = null),
                    (s = []),
                    (p = 0),
            ...
            getPortionReplacementNode: function (t, n) {
              ...
              if ("function" == typeof i)
                return (i = i(t, n)) && i.nodeType
                  ? i
                  : e.createTextNode(String(i));
              var a = "string" == typeof r ? e.createElement(r) : r;
              return (
                a && o && (a.className = o),
                (i = e.createTextNode(this.prepareReplacementString(i, t, n)))
                  .data && a
                  ? (a.appendChild(i), a)
                  : i
              );
            },
            replaceMatch: function (t, n, i, r) {
              var o,
                s,
                a = n.node,
                d = r.node;
              if (a === d) {
                var c = a;
                n.indexInNode > 0 &&
                  ((o = e.createTextNode(c.data.substring(0, n.indexInNode))),
                  c.parentNode.insertBefore(o, c));
                var p = this.getPortionReplacementNode(r, t);
                return (
                  c.parentNode.insertBefore(p, c),
                  r.endIndexInNode < c.length &&
                    ((s = e.createTextNode(c.data.substring(r.endIndexInNode))),
                    c.parentNode.insertBefore(s, c)),
                  c.parentNode.removeChild(c),
                  this.reverts.push(function () {
                    o === p.previousSibling && o.parentNode.removeChild(o),
                      s === p.nextSibling && s.parentNode.removeChild(s),
                      p.parentNode.replaceChild(c, p);
                  }),
                  p
                );
              }
              (o = e.createTextNode(a.data.substring(0, n.indexInNode))),
                (s = e.createTextNode(d.data.substring(r.endIndexInNode)));
              for (
                var h = this.getPortionReplacementNode(n, t),
                  f = [],
                  l = 0,
                  u = i.length;
                l < u;
                ...
                var g = i[l],
                  x = this.getPortionReplacementNode(g, t);
                g.node.parentNode.replaceChild(x, g.node),
                  this.reverts.push(
                    (function (e, t) {
                      return function () {
              ...
              var N = this.getPortionReplacementNode(r, t);
              return (
  ...
  const n = {}.hasOwnProperty,
    i = Object.assign({}, t.NON_CONTIGUOUS_PROSE_ELEMENTS, {
      ins: 1,
      del: 1,
      s: 1,
      a: 1,
    }),
    r = Object.assign({}, t.NON_PROSE_ELEMENTS, {
      pre: 1,
      code: 1,
      sup: 1,
      sub: 1,
  ...
  return class {
    constructor(e) {
      ...
      (this.rootSelector = e || ".heti"),
        (this.REG_FULL = new RegExp(t ? a : p, "g")),
        (this.REG_START = new RegExp(d, "g")),
        (this.REG_END = new RegExp(t ? c : h, "g")),
        (this.offsetWidth = t ? 0 : 1),
        (this.funcForceContext = function (e) {
          return n.call(i, e.nodeName.toLowerCase());
        }),
        (this.funcFilterElements = function (e) {
          return !(
            (e.classList && e.classList.contains("heti-skip")) ||
            n.call(r, e.nodeName.toLowerCase())
          );
        });
    }
    spacingElements(e) {
    ...
    spacingElement(e) {
      ...
      t(
        ...
        Object.assign({}, n, {
          find: this.REG_FULL,
          replace: (e) =>
            i("heti-spacing", "heti-spacing-start heti-spacing-end", e.text),
