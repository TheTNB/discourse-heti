  ...
  Finder.prototype = {
    ...
    replaceMatch: function (match, startPortion, innerPortions, endPortion) {
      ...
      if (matchStartNode === matchEndNode) {
        ...
        let newNode = this.getPortionReplacementNode(endPortion, match);
        ...
        let firstNode = this.getPortionReplacementNode(startPortion, match);

        for (let i = 0, l = innerPortions.length; i < l; ++i) {
          let portion = innerPortions[i];
          let innerNode = this.getPortionReplacementNode(portion, match);
        ...
        let lastNode = this.getPortionReplacementNode(endPortion, match);
